...
import static com.example.neurochat.chatwin.reciverIImg;
import static com.example.neurochat.chatwin.senderImg;
...
public class messageAdpter extends RecyclerView.Adapter {
    ...
    public messageAdpter(Context context, ArrayList<msgModelclass> messagesAdpterArrayList) {
